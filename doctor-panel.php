  ...
  * License: https://bootstrapmade.com/license/
  ======================================================== -->
		...
		<style>
			...
			/* Example of adjusting padding/margin */
			.padding-top-sm {
				padding-top: 5px;
...
<body>
		...
		<div class="container d-flex align-items-center">
			...
			<nav id="navbar" class="navbar order-last order-lg-0">
				<ul>
					...
					<li><a class="btn btn-danger text-white" href="index1.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Logout</a></li>
					<!-- <a class="nav-link btn btn-danger text-white" href="logout1.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Logout</a> -->
				</ul>
				<i class="bi bi-list mobile-nav-toggle"></i>
			</nav><!-- .navbar -->

			<a href="pregister.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">Make an</span> Appointment</a>
	...
	<body style="padding-top:50px;">
		<div class="container-fluid" style="margin-top:50px;">
			<h3 class="text-white" style="margin-left: 40%; padding-bottom: 20px;font-family:'IBM Plex Sans', sans-serif;"> Welcome &nbsp<?php echo $_SESSION['dname'] ?> </h3>
			<div class="row">
