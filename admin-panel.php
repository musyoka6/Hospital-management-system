    ...
    if (date("Y-m-d", $appdate1) >= $cur_date) {
        if ((date("Y-m-d", $appdate1) == $cur_date and date("H:i:s", $apptime1) > $cur_time) or date("Y-m-d", $appdate1) > $cur_date) {
            ...
            if (mysqli_num_rows($check_query) == 0) {
                $string_query = "insert into appointmenttb(pid,fname,lname,gender,email,contact,doctor,docFees,appdate,apptime,userStatus,doctorStatus) values($pid,'$fname','$lname','$gender','$email','$contact','$doctor','$docFees','$appdate','$apptime','1','1')";
                $query = mysqli_query($con, $string_query);
...
<body>
    ...
    <header id="header" class="fixed-top" style="background-color:maroon;">
        <div class="container d-flex align-items-center">
            <h1 class="logo me-auto "><a class="text-white" href="index.php">
                    <img src="./images/logo.png" style="width:4rem;" /> <br>JAMY HOSPITAL
                </a></h1>
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="btn btn-danger text-white" href="index1.php">Logout</a></li>
                </ul>
                <i class="bi bi-list mobile-nav-toggle"></i>
            </nav><!-- .navbar -->

            <a href="pregister.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">Make an</span>
                Appointment</a>
    ...
    <body style="padding-top:50px;">
        ...
        <div class="container-fluid" style="margin-top:50px;">
            <h2 class="text-white" style="margin-left: 40%; padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif;">
                Welcome&nbsp;<span class="text-danger" id="username"><?php echo $username ?></span>
            </h2>
            <script>
                // Function to make the username text blink
                function blinkText() {
                    var username = document.getElementById("username");
                    username.style.visibility = (username.style.visibility == 'hidden' ? 'visible' : 'hidden');
                }

                // Call the blinkText function every second after 3 seconds
                setTimeout(function() {
                                        ...
                                        <tr>
											...
											title="Pay Bill" tooltip-placement="top" tooltip="Remove"><button class="btn btn-success">Pay</button>
                                                    ...
                                                    <a href="admin-panel.php?ID=<?php echo $row['ID'] ?>">
                                                        ...
                                                        <input type="submit" onclick="alert('Bill Paid Successfully');" name="generate_bill" class="btn btn-success" value="Download Receipt" />
                                                    </a>
                                            </td>
                                            </form>
                                        </tr>
